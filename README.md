...
+ ■ `Funcionalidade 1` Verificação de informações, podendo ser usado por todas as turmas.;

+ ■ `Funcionalidade 2` Feedbacks confiáveis, com confirmações através de fontes.;
